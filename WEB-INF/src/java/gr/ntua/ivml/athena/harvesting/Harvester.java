package gr.ntua.ivml.athena.harvesting;


import gr.ntua.ivml.athena.db.DB;
import gr.ntua.ivml.athena.harvesting.io.MultipleRecordsZipImporter;
import gr.ntua.ivml.athena.harvesting.xml.schema.HeaderType;
import gr.ntua.ivml.athena.harvesting.xml.schema.ListIdentifiersType;
import gr.ntua.ivml.athena.harvesting.xml.schema.ListMetadataFormatsType;
import gr.ntua.ivml.athena.harvesting.xml.schema.MetadataFormatType;
...
public class Harvester implements Runnable{
	...
	public Harvester(String url){
		this.baseURL = url;
		try {
			jc = JAXBContext.newInstance( "gr.ntua.ivml.athena.harvesting.xml.schema" );
