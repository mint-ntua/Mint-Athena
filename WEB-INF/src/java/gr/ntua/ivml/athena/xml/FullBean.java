...
public class FullBean {
    ...
    // Dublin Core Terms extended / ESE field
	...
	public void setEuropeanaType(String europeanaType) {
		this.europeanaType = europeanaType;
	}
	...
	public void setEuropeanaSource(String[] europeanaSource) {
		this.europeanaSource = europeanaSource;
	}
	...
	public boolean isEuropeanahasObject() {
		return europeanahasObject;
	}
	public void setEuropeanahasObject(boolean europeanahasObject) {
		this.europeanahasObject = europeanahasObject;
	}
