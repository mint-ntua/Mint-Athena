...
<!-- Europeana elements in requested order --> 
	...
	<xsl:template name="record">
		...
		<xsl:for-each select="lido:recordWrap/lido:recordSource/lido:legalBodyName/lido:appellationValue[not(@lido:label = 'europeana:dataProvider')][not(@lido:pref = 'alternate')]">
		<!-- ignoring alternative names -->
			<dc:source>
				<xsl:call-template name="langattr">
					<xsl:with-param name="desclang" select="$admlang" />
