...
<s:form name="mapform" action="Mapselection" enctype="multipart/form-data" style="width:100%;margin-top:-25px;">
	...
	<p>&nbsp;Move transformed imports between the published and unpublished lists and then click the "Done" button:</p>
	    <div class="workarea">
		   ...
		   <%i++;%>
		        <li class="list1" id="li1_<%=i %>" style="background: url(/images/grey.gif) repeat scroll 0% 0% transparent;">
		...
		<div class="workarea">
		 <div id="pub">&nbsp;Published</div>
		  <ul id="ul2" class="draglist">
		   ...
		   <%i++;%>
		        <li class="list2" id="li2_<%=i %>" style="background: url(images/sprite.png) repeat scroll 0% 0% transparent;">
