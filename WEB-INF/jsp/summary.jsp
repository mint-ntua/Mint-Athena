...
<link rel="stylesheet" type="text/css" href="css/mapping/SyntaxHighlighter.css"></link>
     ...
     <div id="importsPanel"> 
		...
		<%} else if(orgId==null && user.getOrganization()!=null ){ 
		       ...
		       %>
		        ...
		        <%} %>
		<%}else if(orgId==null && user.getOrganization()==null  && user.getAthenaRole().equals("superuser")){ 
	   %>
