...
<!--
  ...
  Provided for ATHENA project, 2011-01-20. 
			...
			<xsl:for-each select="lido:lidoWrap/lido:lido">
				...
				<xsl:choose>
					...
					<xsl:when test="contains(lido:administrativeMetadata/lido:recordWrap/lido:recordType, '/multipleResources') 
						and 
						lido:administrativeMetadata/lido:resourceWrap/lido:resourceSet/lido:linkResource[@lido:type='image_thumb'][string-length(.)&gt;0]">

						<xsl:for-each select="lido:administrativeMetadata/lido:resourceWrap/lido:resourceSet/lido:linkResource[@lido:type='image_thumb'][string-length(.)&gt;0]">
...
<!-- Europeana elements in requested order --> 
					...
					<europeana:type>
						...
						<xsl:value-of select="../../../../lido:descriptiveMetadata/lido:objectClassificationWrap/lido:classificationWrap/lido:classification[@lido:type = 'europeana:type'][1]/lido:term[string-length(.)&gt;0][1]" />
					</europeana:type>
...
<!-- Europeana elements in requested order --> 
						<xsl:for-each select="lido:linkResource[string-length(.)&gt;0]">
							<xsl:if test="position() = 1">
								<europeana:object>
									<xsl:value-of select="." />
								</europeana:object>
					...
					<xsl:if test="not(../..//lido:recordWrap/lido:recordInfoSet/lido:recordInfoLink)">
						<xsl:for-each select="lido:linkResource[string-length(.)&gt;0][1]">
								<europeana:isShownBy>
									<xsl:value-of select="." />
								</europeana:isShownBy>
						</xsl:for-each>
...
<!-- Europeana elements in requested order --> 
					...
					<europeana:dataProvider>
						<xsl:for-each select="lido:administrativeMetadata/lido:recordWrap/lido:recordSource/lido:legalBodyName/lido:appellationValue[string-length(.)&gt;0][1]">
							<xsl:value-of select="." />
                            <xsl:if test="position()!=last()">
                                <xsl:text> / </xsl:text>
                            </xsl:if>
					...
					<xsl:for-each select="lido:administrativeMetadata/lido:recordWrap/lido:recordInfoSet/lido:recordInfoLink[string-length(.)&gt;0]">
						<xsl:if test="position() = 1">
							<europeana:isShownAt>
								<xsl:value-of select="." />
							</europeana:isShownAt>
					...
					<xsl:choose>
						<xsl:when test="lido:administrativeMetadata/lido:resourceWrap/lido:resourceSet/lido:linkResource[@lido:type = 'image_master'][string-length(.)&gt;0]">
						<xsl:for-each select="lido:administrativeMetadata/lido:resourceWrap/lido:resourceSet/lido:linkResource[@lido:type = 'image_master'][string-length(.)&gt;0]">
							<xsl:if test="position() = 1">
								<europeana:isShownBy>
									<xsl:value-of select="." />
								</europeana:isShownBy>
						...
						<xsl:otherwise>
							<xsl:for-each select="lido:administrativeMetadata/lido:resourceWrap/lido:resourceSet/lido:linkResource[string-length(.)&gt;0]">
								<xsl:if test="position() = 1">
									<europeana:isShownBy>
										<xsl:value-of select="." />
									</europeana:isShownBy>
	...
	<xsl:template name="descriptiveMetadata">
					...
					<xsl:for-each select="lido:objectIdentificationWrap/lido:inscriptionsWrap/lido:inscriptions[string-length(.)&gt;0]">
						...
						<xsl:for-each select="lido:objectIdentificationWrap/lido:objectMeasurementsWrap/lido:objectMeasurementsSet">
							<xsl:choose>
								...
								<xsl:for-each select="lido:objectMeasurements">
									...
									<xsl:for-each select="lido:measurementsSet[string-length(@lido:value)&gt;0]">
									<dcterms:extent>
										<xsl:attribute name="xml:lang"><xsl:value-of select="$desclang" /></xsl:attribute>
					...
					<xsl:for-each select="lido:objectRelationWrap/lido:relatedWorksWrap/lido:relatedWorksSet[count(not(lido:relatedWork/lido:object/lido:objectNote='')) &gt; 0 or count(not(lido:relatedWork/lido:displayObject='')) &gt; 0]">
						<xsl:choose>
	...
	<xsl:template name="resourceView">
		...
		<xsl:for-each select="lido:resourceViewDescription[string-length(.)&gt;0]">
			<dc:description>
				<xsl:call-template name="langattr">
		...
		<xsl:for-each select="lido:resourceViewDate[string-length(.)&gt;0]">
			<dc:description>
				<xsl:call-template name="langattr">
					<xsl:with-param name="desclang" select="$admlang" />
				</xsl:call-template>
		...
		<xsl:for-each select="lido:resourceSource[string-length(.)&gt;0]">
	...
	<xsl:template name="work">
		...
		<xsl:choose>
			...
			<xsl:when test="lido:rightsWorkWrap/lido:rightsWorkSet/lido:rightsType[string-length(.)&gt;0] and not(lido:rightsWorkWrap/lido:rightsWorkSet/lido:rightsHolder/lido:legalBodyName)">
				<xsl:for-each select="lido:rightsWorkWrap/lido:rightsWorkSet/lido:rightsType[string-length(.)&gt;0]">
					<dc:rights>
							<xsl:call-template name="langattr">
								<xsl:with-param name="desclang" select="$admlang" />
							</xsl:call-template>
			...
			<xsl:when test="lido:rightsWorkWrap/lido:rightsWorkSet/lido:rightsHolder/lido:legalBodyName">
				<xsl:for-each select="lido:rightsWorkWrap/lido:rightsWorkSet/lido:rightsHolder/lido:legalBodyName[not(lido:appellationValue/@lido:pref = 'alternate')]">
						<dc:rights>
							...
							<xsl:if test="../../lido:rightsType[string-length(.)&gt;0]">
								<xsl:value-of select="concat(../../lido:rightsType[string-length(.)&gt;0][1], ': ')" />
							</xsl:if>
	...
	<xsl:template name="resource">
		...
		<xsl:variable name="admlang" select="../../@xml:lang" />
		<xsl:variable name="resourceSource" select="../lido:resourceSource[1]" />	 
		...
		<xsl:choose>
			...
			<xsl:when test="lido:rightsResource/lido:rightsType[string-length(.)&gt;0] and not(lido:rightsResource/lido:rightsHolder/lido:legalBodyName)">
				<xsl:for-each select="lido:rightsResource/lido:rightsType[string-length(.)&gt;0]">
					<dc:rights>
						<xsl:call-template name="langattr">
							<xsl:with-param name="desclang" select="$admlang" />
						</xsl:call-template>
			...
			<xsl:when test="lido:rightsResource/lido:rightsHolder/lido:legalBodyName">
				<xsl:for-each select="lido:rightsResource/lido:rightsHolder/lido:legalBodyName[not(lido:appellationValue/@lido:pref = 'alternate')]">
						<dc:rights>
							...
							<xsl:if test="../../lido:rightsType[string-length(.)&gt;0]">
								<xsl:value-of select="../../lido:rightsType[string-length(.)&gt;0][1]" />
							</xsl:if>
