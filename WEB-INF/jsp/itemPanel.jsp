...
<%@ taglib prefix="s" uri="/struts-tags" %>
	...
	<tr><td height="10px;">&nbsp;</td></tr>
		<tr><td>
		<table width="398" cellpadding="0" cellspacing="0" height="13"
			bgcolor="#8CB85C">
			<tr>
				<td height="12" width="13" valign="top" align="left"><img
					src="images/org_top_left.png" width="13" height="12"></td>
				<td height="20"><font style="color: #FFFFFF">&nbsp;<b>Items</b>
				</font></td>
	...
	<!-- 	<table border="0" cellspacing="0" cellpadding="0">
		...
		&nbsp;Filter by: <s:select theme="simple" label="Filter by" name="filteritems" headerKey="-1" headerValue="-- All imports --" list="imports" listKey="dbID" listValue="originalFilename" value="%{uploadId}" onChange="javascript:ajaxItemPanel(0,10,${organizationId},document.getElementById('filteritems').value,${userId});"></s:select>
		...
		<s:if test="lido==false">
		 <a href="javascript:ajaxXmlInput('<s:property value="uploadId"/>', '<s:property value="nodeId"/>')"><img
					...
					title="input xml preview" border="0"></a><a href="javascript:ajaxXmlPreview('<s:property value="uploadId"/>', '<s:property value="nodeId"/>')"><img
					src="images/webview.png" style="vertical-align: top;padding-right:0px;"
					title="mappings xml preview" border="0"></a>
		</s:if>
					<s:if test="transformed==true || lido==true">
					<a href="javascript:ajaxXmlTransformed('<s:property value="uploadId"/>', '<s:property value="nodeId"/>')">
					<img src="images/athenatrans.gif" style="vertical-align: top;padding-right:3px;" title="transformed xml preview" border="0">
					</a></s:if>
	...
	<table border="0" width="390" cellspacing="0" cellpadding="3">
       ...
       <tr>
			...
			<td>
			<a class="button" id="buttongo" onclick="javascript:this.blur();ajaxItemPanel(document.getElementById('pageJump_<s:property value="organizationId"/>').value*10,10,<s:property value="organizationId"/>,<s:property value="uploadId"/>,<s:property value="userId"/> )"><span>go</span></a>  </td>
		</tr>
