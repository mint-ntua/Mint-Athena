...
<%@ page import="gr.ntua.ivml.athena.persistent.Lock"%>
...
<div style="width:400px;cursor: pointer;"><a onClick="javascript:toggleSlider();">Active locks in your account!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style="float:right;position:relative;"><img src="images/info.png" style="align:right;padding-right:2px;"/></div></a>
                </div>
